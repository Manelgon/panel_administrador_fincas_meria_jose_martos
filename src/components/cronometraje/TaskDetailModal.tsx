...
export default function TaskDetailModal({ task, onClose, onDeleteClick, numCommunities = 1 }: TaskDetailModalProps) {
    ...
    return (
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[9999] flex justify-center items-center p-4 sm:p-6">
            <div
                className="bg-white w-full max-w-lg rounded-xl shadow-2xl flex flex-col overflow-hidden max-h-[95dvh] animate-in fade-in zoom-in duration-200"
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                    ...
                    {/* Temporalidad */}
                    <div>
                        <h3 className="text-[10px] font-bold text-neutral-900 uppercase tracking-widest pb-2 mb-4 border-b border-[#bf4b50]">Temporalidad</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                    ...
                    {/* Nota */}
                    <div>
                        <h3 className="text-[10px] font-bold text-neutral-900 uppercase tracking-widest pb-2 mb-4 border-b border-[#bf4b50]">Nota / Descripción</h3>
