    ...
    const handleStop = async () => {
        await withLoading(async () => {
            ...
            try {
                ...
                // Si la tarea estaba vinculada a un ticket, escribir en el timeline
                if (activeTask?.incidencia_id) {
                    ...
                    if (user) {
                        ...
                        await supabase.from('record_messages').insert([{
                            ...
                            user_id: user.id,
                            content: `✅ Tarea realizada · ${activeTask.tipo_tarea || 'Tarea'} · Tiempo total ${durStr}${activeTask.nota ? ` · ${activeTask.nota}` : ''}`,
                        }]);
                    }
                }
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-64">
                <div className="w-6 h-6 border-2 border-[#bf4b50]/40 border-t-[#bf4b50] rounded-full animate-spin" />
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 pb-10">
                        ...
                        <div className="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                            <div>
                                <h2 className="text-base font-bold text-neutral-900 flex items-center gap-2">
                                    <FileText className="w-4 h-4 text-[#a03d42]" />
                                    Configurar Informe
                                </h2>
                        ...
                        <div className="p-6 space-y-5">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 text-sm border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#bf4b50] focus:border-transparent"
                                        />
                                    </div>
                                    <div className="space-y-1">
                            ...
                            <label className="flex items-start gap-3 cursor-pointer p-3 rounded-xl border border-neutral-200 hover:bg-neutral-50 transition-colors">
                                <input
                                    ...
                                    className="mt-0.5 w-4 h-4 rounded border-neutral-300 accent-[#a03d42]"
                                />
                                <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4" id="crono-kpi-cards">
                ...
                <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm p-5">
                    <div className="flex items-center gap-2 mb-1">
                        <BarChart2 className="w-4 h-4 text-[#a03d42]" />
