...
import { Trash2, FileText, Check, Plus, Paperclip, Download, X, RotateCcw, Building, Users, Clock, Search, Filter, Loader2, AlertCircle, Eye, RefreshCw, Send, Save, Share2, MoreHorizontal, MessageSquare, ChevronDown, UserCog, Pause, CalendarClock, Pencil, Play, Wrench, Square } from 'lucide-react';
...
export default function IncidenciasPage() {
    ...
    // Cronómetro automático en el detalle del ticket
    ...
    useEffect(() => {
        ...
        const fetchActive = async () => {
            ...
            } catch { /* silent: no bloquear apertura del detalle */ }
        };
        fetchActive();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editingId) {
                ...
                // Registrar el tiempo invertido en crear el ticket
                                            ...
                                            <div className="flex items-center justify-between mb-1">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    <input
                                                        ...
                                                        className="w-3 h-3 rounded border-neutral-300 text-[#bf4b50] focus:ring-[#bf4b50]"
                                                    />
                    ...
                    >
                        ...
                        <div className="px-4 py-3 bg-white border-t border-neutral-100 flex items-center justify-between shrink-0 gap-2">
                            <ModalActionsMenu actions={[
                                ...
                                { label: 'Añadir tiempo', icon: <Clock className="w-4 h-4" />, onClick: () => { setAddTimeIncidencia(selectedDetailIncidencia); setShowAddTimeModal(true); } },
                    ...
                    >
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 py-3 bg-[#bf4b50] hover:bg-[#a03d42] text-white rounded-xl font-bold transition-transform active:scale-[0.98] shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                    ...
                    >
                        ...
                        <div className="flex gap-3 w-full">
                            ...
                            <button
                                ...
                                className="flex-1 py-3 bg-[#bf4b50] hover:bg-[#a03d42] text-white rounded-xl font-bold transition-transform active:scale-[0.98] shadow-sm"
                            >
                                Eliminar
                            </button>
                        </div>
